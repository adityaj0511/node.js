            ...
            li.innerHTML = `
                <div class="row w-100">
                    ...
                    <div class="col-md-3 d-flex align-items-center">
                        <button style="background-color: yellow;" class="btn  btn-sm me-2" onclick="editTodo(${todo.id})">Edit</button>
                        <button style="background-color: pink;" class="btn btn-sm" onclick="deleteTodo(${todo.id})">Delete</button>
                    </div>
                </div>
            `;
